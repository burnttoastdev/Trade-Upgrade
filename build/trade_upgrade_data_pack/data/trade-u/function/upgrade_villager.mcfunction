...
execute if entity @e[type=villager, limit=1, sort=nearest, distance=..5, tag=!upgraded, nbt=!{VillagerData: {profession: "minecraft:none"}}, nbt=!{VillagerData: {level: 1}}] run function trade-u:upgrade_villager/nested_execute_0
